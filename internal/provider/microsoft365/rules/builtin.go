...
func BuiltinConditionalAccessRules() []corerules.Rule {
	return []corerules.Rule{
		...
		},
		{
			...
			Category:            "conditional-access",
			Service:             "entra",
			RequiredPermissions: []string{"Policy.Read.All", "RoleManagement.Read.Directory"},
			DataRequirements:    []string{"conditional_access_policies", "directory_role_assignments", "privileged_principals"},
