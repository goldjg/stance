...
func TestBundleUnmarshalDefaultsMissingSlices(t *testing.T) {
	...
	if bundle.Organization == nil || bundle.CAPolicies == nil || bundle.DirectoryRoleDefinitions == nil || bundle.DirectoryRoleAssignments == nil || bundle.PrivilegedPrincipals == nil {
